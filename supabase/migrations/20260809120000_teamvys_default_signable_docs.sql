    ...
    values (vys, 'Přihláška', 'electronic', $j$
      {
        ...
        "clauses": [
          "Pořadatel: Team VYS, IČO 29883075, se sídlem Puškinova 520/37, 682 01 Vyškov. Kontakt: info@teamvys.cz, +420 734 167 417.",
    ...
    values (vys, 'Souhlas se zpracováním osobních údajů (GDPR)', 'electronic', $j$
      {
        ...
        "clauses": [
          "Správcem osobních údajů je Team VYS, IČO 29883075, se sídlem Puškinova 520/37, 682 01 Vyškov.",
